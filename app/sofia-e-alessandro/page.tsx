      ...
      <div className={`transition-all duration-1000 delay-500 ${isOpen ? "opacity-100" : "opacity-0"}`}>
        ...
        <section className="min-h-screen flex flex-col items-center justify-center text-center px-6 relative">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            {/* Testo che appare in dissolvenza */}
        ...
        <div className="max-w-5xl mx-auto px-6 space-y-64 pb-40">
          ...
          <section className="text-center space-y-16">
            ...
            <div className="flex flex-col items-center">
              ...
              <button onClick={() => fileInputRef.current?.click()} className="px-16 py-6 border border-black text-[10px] uppercase tracking-[0.4em] font-bold hover:bg-black hover:text-white transition-all duration-700 shadow-xl cursor-pointer">Carica un momento</button>
